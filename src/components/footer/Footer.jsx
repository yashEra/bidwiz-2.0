  ...
  return (
    <>
      <div className="bg-[#0052D4]">
        <div className=" text-white w-full py-[60px] grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-left px-[5%] md:px-[10%]">
          ...
          <div className="flex flex-col items-start pt-8">
            ...
            <ul className="flex flex-col items-start font-medium">
              <li className="text-[#8EC2F2]">
                <a href="#">
                  BidWiz is an online auction website that provides a platform
                  for users to bid on a wide range of products and items.
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-row justify-center py-8 px-[5%] md:px-[10%]">
          <span className="text-md text-white font-bold">
            Made With 💗 By BidWiz Team. All Right Reserved.
          </span>
        </div>
      </div>
    </>
