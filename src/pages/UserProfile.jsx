    ...
    <div>
      ...
      <div className="bg-[url()] bg-[#ececec] flex items-center justify-center min-h-screen text-[#9e9cb6]">
            <section className="w-full max-w-[430px] relative bg-[#231f39]/60 rounded-[6px] backdrop-blur-sm mx-2 overflow-hidden">
                <a href="/" target="_blank" className="absolute text-[#231f39] bg-yellow-400 rounded-[4px] top-6 left-6 px-2 py-1 text-sm font-bold roll-in-blurred-right">
                    Client
                </a>
                ...
                <h1 className="text-xl font-bold text-center">{userData.name || "Test User"}</h1>
                <small className="block my-1 text-center">{userData.username || "testuser2"}</small>
                <div className="flex items-center justify-center gap-2 w-[80%] mx-auto mt-5 mb-10">
                    ...
                    <button type="button" className="flex-1 border border-[#1357DE] text-[#ffffff] rounded-[4px] py-3 transition-all duration-150 ease-in hover:bg-[#472e99]  hover:text-white" onClick={logout}>Logout</button>
                </div>
